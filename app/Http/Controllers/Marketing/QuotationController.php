...
class QuotationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketing.quotation.index', compact('quotations'));
    }
    ...
    public function create()
    {
        ...
        return view('marketing.quotation.form', [
            'clients' => $clients,
    ...
    public function edit(Quotation $quotation)
    {
        ...
        return view('marketing.quotation.form', compact('quotation', 'clients', 'noQuotationNumber'));
    }
    ...
    {
        return view('marketing.quotation.show', compact('quotation'));
    }
