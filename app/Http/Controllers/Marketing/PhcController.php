...
class PhcController extends Controller
{
    ...
    public function create($project_id)
    {
        ...
        $users = User::whereHas('role', function ($q) {
            $q->whereIn('name', ['marketing', 'engineer']);
        })->get();

        $phc = null;

        return view('marketing.phcs.form', compact('project', 'users', 'phc'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('project.show', $request->project_id)->with('success', 'PHC created successfully.');
    }
    ...
    public function edit(PHC $phc)
    {
        ...
        return view('marketing.phcs.form', compact('phc', 'project', 'users'));
    }
    ...
    public function update(Request $request, PHC $phc)
    {
        ...
        return redirect()->route('project.show', $phc->project_id)->with('success', 'PHC updated successfully.');
    ...
    public function show(PHC $phc)
    {
        ...
        return view('marketing.phcs.show', compact('phc'));
    }
