        ...
        <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div>
                ...
                <nav class="mt-4 space-y-1 px-4">
                    ...
                    <a href="#"
                        class="block px-4 py-2 rounded hover:bg-[#005f87] transition">📁 Projects</a>
                    <a href="#"
                        class="block px-4 py-2 rounded hover:bg-[#005f87] transition">📈 Reports</a>
                    <a href="#"
                        class="block px-4 py-2 rounded hover:bg-[#005f87] transition">⚙️ Settings</a>
                </nav>
            </div>
