    ...
    <section class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form wire:submit.prevent="save" class="p-6 space-y-5">
            <div>
                ...
                @error('names') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <textarea wire:model.defer="description" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150"
                    placeholder="Detailed description of the scope"></textarea>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4">
                @if($isEditing)
                    <button type="button" wire:click="resetForm"
                        class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150">
                        Cancel
                    </button>
                @endif
                <button type="submit"
                    ...
                    @forelse ($scopeOfWorks as $sow)
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <button wire:click="delete({{ $sow->id }})" onclick="return confirm('Are you sure you want to delete this scope?')"
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-sm text-gray-500">
                                No scope of work found. Start by adding a new scope.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
