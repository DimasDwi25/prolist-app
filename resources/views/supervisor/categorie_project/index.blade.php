...
<div class="p-3 md:p-4 space-y-3">
    ...
    {{-- <div class="flex flex-col md:flex-row justify-between gap-2">
        ...
        <form action="{{ route('project.import') }}" method="POST" enctype="multipart/form-data" class="flex gap-2 items-center">
            @csrf
            <input type="file" name="file" required class="border rounded px-2 py-1 text-xs">
            <button class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-md text-xs">
                📥 Import
            </button>
        </form>
    </div> --}}
