@extends(Auth::user()->role->name === 'super_admin' ? 'admin.layouts.app' : 'supervisor.layouts.app')
...
@section('content')
    ...
    <form action="{{ route('client.store') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md w-full max-w-4xl">
        ...
        <div class="flex justify-end mt-8">
            <a href="{{ route('supervisor.client') }}" class="mr-4 text-gray-600 hover:underline">Cancel</a>
            <button type="submit"
