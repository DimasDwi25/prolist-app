                ...
                <nav class="mt-4 space-y-1 px-4">
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition class="pl-4 mt-1 space-y-1 text-sm">
                            <a href="#" class="block px-4 py-2 rounded hover:bg-[#005f87]">📈 Marketing Reports</a>
                            <a href="#" class="block px-4 py-2 rounded hover:bg-[#005f87]">📈 Sales Reports</a>
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition class="pl-4 mt-1 space-y-1 text-sm">
                            <a href="{{ route('marketing.category') }}"
                                class="block px-4 py-2 rounded hover:bg-[#005f87]">📁 Categorie Projects</a>
                            <a href="{{ route('marketing.project') }}"
                                class="block px-4 py-2 rounded hover:bg-[#005f87]">🛠 Projects</a>
                        </div>
                    </div>

                    <a href="{{ route('marketing.client') }}"
