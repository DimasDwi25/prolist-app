...
@if ($isTailwind)
    <div class="@if ($this->getColumnSelectIsHiddenOnMobile()) hidden sm:block @elseif ($this->getColumnSelectIsHiddenOnTablet()) hidden md:block @endif mb-4 w-full md:w-auto md:mb-0 md:ml-2">
        ...
        >
            ...
            >
                <div class="bg-white rounded-md shadow-xs text-white">
                                ...
                                <input
                                    {{
                                        ...
                                        ->class([
                                            ...
                                            'text-indigo-600 border-gray-300 focus:border-indigo-300 focus:ring-indigo-200 bg-gray-900 text-white border-gray-600 hover:bg-gray-600 focus:bg-gray-600' => $this->getColumnSelectMenuOptionCheckboxAttributes()['default-colors'],
                                        ])
                                        ->except(['default-styling', 'default-colors'])
                                    }}
                                    wire:loading.attr="disabled"
