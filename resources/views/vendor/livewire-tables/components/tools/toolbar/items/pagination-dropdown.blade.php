...
<div @class(['ml-0 ml-md-2' => $isBootstrap4, 'ms-0 ms-md-2' => $isBootstrap5])>
    <select 
        ...
        {{ 
            $attributes
                ...
                ->class([
                    ...
                    'block w-full rounded-md shadow-sm sm:text-sm sm:leading-5 focus:ring focus:ring-opacity-50 transition ease-in-out duration-150' 
